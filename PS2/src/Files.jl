...
Refactor method to read csv file Compounds.data and create a data structure. 

Arguments
'path::String': the compound name to translate

Return Dict with compound name as keys and compound formula as instances. 
